...
public class TestBoundaryAnalyzer {
	...
	public static void main(String[] args) throws IOException, LogicException {
		...
		Color result1 = BoundaryAnalyzer.isPixelInsidePolygon(image, 189, 68, pxlTracker);
		System.out.println("Result 1 isNull: " + (result1 == null) + " [Expected: true]");
		
		Color result2 = BoundaryAnalyzer.isPixelInsidePolygon(image, 121, 34, pxlTracker);
		...
		Color result3 = BoundaryAnalyzer.isPixelInsidePolygon(image, 25, 300, pxlTracker);
		...
		Color result4 = BoundaryAnalyzer.isPixelInsidePolygon(image2, 297, 110, pxlTracker2);
		System.out.println("Result 4: " + (result4 == null) + " [Expected: true]");
		
		Color result5 = BoundaryAnalyzer.isPixelInsidePolygon(image2, 243, 46, pxlTracker2);
		...
		Color result6 = BoundaryAnalyzer.isPixelInsidePolygon(image3, 541, 131, pxlTracker3);
		System.out.println("Result 6: " + (result6 == null) + " [Expected: true]");
		
		Color result7 = BoundaryAnalyzer.isPixelInsidePolygon(image3, 311, 131, pxlTracker3);
		...
		Color result8 = BoundaryAnalyzer.isPixelInsidePolygon(image3, 331, 191, pxlTracker3);
